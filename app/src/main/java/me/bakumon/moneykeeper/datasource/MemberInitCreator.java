...
public class MemberInitCreator {
    public static Member[] createMemberData() {
        ...
        Member member;
        member = new Member(res.getString(R.string.text_member_self),1);
        list.add(member);
        member = new Member(res.getString(R.string.text_member_family),2);
        list.add(member);
        ...
        list.add(member);
        member = new Member(res.getString(R.string.text_member_parents),6);
        list.add(member);
